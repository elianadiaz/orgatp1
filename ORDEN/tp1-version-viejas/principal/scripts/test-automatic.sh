...
./tp1 -i - -o ./outputs/outputInformeEjemplo1.txt < ./inputs/inputInformeEjemplo1.txt -I 5 -O 100
...
./tp1 -i ./inputs/inputInformeEjemplo2.txt -o - > ./outputs/outputInformeEjemplo2.txt -I 10 --obuf-bytes 2
...
./tp1 -i - -o - < ./inputs/inputInformeEjemplo2.txt > ./outputs/outputInformeEjemplo2.txt --ibuf-bytes 10 --obuf-bytes 10
...
./tp1 --output ./outputs/outputStdin.txt -i - < ./inputs/inputStdin.txt
...
./tp1 -o - -i - < ./inputs/inputInformeEjemplo2.txt > ./outputs/outputInformeEjemplo2.txt
